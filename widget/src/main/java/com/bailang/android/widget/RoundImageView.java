...
public class RoundImageView extends AppCompatImageView {
    ...
    private ColorStateList borderColor = ColorStateList.valueOf(RoundDrawable.DEFAULT_BORDER_COLOR);
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        borderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_qb_border_width, -1);
        ...
        borderColor = a.getColorStateList(R.styleable.RoundedImageView_qb_border_color);
        if (borderColor == null) {
            borderColor = ColorStateList.valueOf(RoundDrawable.DEFAULT_BORDER_COLOR);
        }
    ...
    public void setBorderColor(ColorStateList colors) {
        ...
        borderColor = (colors != null) ? colors : ColorStateList.valueOf(
                RoundDrawable.DEFAULT_BORDER_COLOR);
        updateDrawableAttrs();
        updateBackgroundDrawableAttrs(false);
        if (borderWidth > 0) {
            invalidate();
    ...
    private void updateAttrs(Drawable drawable) {
        ...
        if (drawable instanceof RoundDrawable) {
            ((RoundDrawable) drawable).setScaleType(mScaleType).setCornerRadius(cornerRadius)
